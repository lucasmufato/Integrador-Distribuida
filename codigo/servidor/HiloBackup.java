			...
			while(this.conectado){
				try {
					...
					case asignacionTareaUsuario:
						...
						resultado = "Recibi actualizaci�n: Asignaci�n de tarea a usuario.";
					...
					case parcialTarea:
						...
						resultado = "Recibi actualizaci�n: Resultado parcial de tarea.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
						//MARCO QUE CAMBIO EL OBJETO
				        setChanged();
					...
					case resultadoTarea:
						...
						resultado = "Recibi actualizaci�n: Resultado final de tarea.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
						//MARCO QUE CAMBIO EL OBJETO
				        setChanged();
					...
					case detencionTarea:
						...
						resultado = "Recibi actualizaci�n: Detencion de tarea.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
						//MARCO QUE CAMBIO EL OBJETO
				        setChanged();
					...
					case completitudBloque:
						...
						resultado = "Recibi actualizaci�n: Bloque completado.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
						//MARCO QUE CAMBIO EL OBJETO
				        setChanged();
					...
					case asignacionPuntos:
						...
						resultado = "Recibi actualizaci�n: Asignaci�n de puntos a usuario.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
				        setChanged();
				        notifyObservers(resultado);
					...
					case generacionBloque:
						...
						resultado = "Recibi actualizaci�n: Generacion de bloque.";
						System.out.println(resultado);
						this.logger.guardar("HiloBackup", resultado);
						setChanged();
						notifyObservers(resultado);
					...
					case generacionTarea:
						...
						resultado = "Recibi actualizaci�n: Generacion de tarea.";
						this.logger.guardar("HiloBackup", resultado);
						setChanged();
						notifyObservers(resultado);
